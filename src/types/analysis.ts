...
/** 分析種別 */
export type AnalysisKey = 'chromaMap' | 'chromaHistogram' | 'lightnessMap' | 'lightnessHistogram' | 'gamutPointCloud' | 'colorClustering' | 'hueAnalysis'
